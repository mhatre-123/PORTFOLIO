...
import { FileText, ChevronRight, BookOpen, GraduationCap, Sparkles } from 'lucide-react';

export const Hero: React.FC = () => {
  return (
    <section id="home" className="relative h-screen min-h-[650px] flex items-center pt-32 pb-12 overflow-hidden bg-white">
      ...
      <div className="section-container relative grid lg:grid-cols-12 gap-12 items-center -mt-12">
        {/* Left Content */}
        <div className="lg:col-span-7">
          ...
          >
            ...
            <h1 className="text-6xl md:text-7xl lg:text-8xl font-sans font-black tracking-tight leading-[0.9] mb-8 text-slate-900">
              Chaitali <br />
            ...
            <div className="flex flex-wrap items-center gap-4 mb-8">
              <div className="flex items-center gap-3 px-5 py-2.5 bg-slate-50 border border-slate-200 rounded-2xl shadow-sm">
                <GraduationCap className="text-primary-600" size={24} />
                <span className="text-lg font-bold text-slate-800">Computer Engineering</span>
              </div>
              <div className="flex items-center gap-3 px-5 py-2.5 bg-primary-600 text-white shadow-xl shadow-primary-500/20 rounded-2xl">
                <BookOpen size={20} />
                <span className="text-lg font-bold">Research Expert</span>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-5">
              ...
              <button className="px-10 py-4.5 rounded-2xl border-2 border-slate-100 font-bold text-slate-700 hover:border-primary-500 hover:text-primary-600 transition-all flex items-center gap-3 group bg-white shadow-sm">
        ...
        <div className="lg:col-span-5 relative flex justify-center lg:justify-end">
          ...
          >
                ...
                <div className="glass p-6 rounded-3xl backdrop-blur-2xl bg-white/80 border-white">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-base font-black text-slate-900 leading-none">Deep Learning Systems</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <motion.div 
              ...
              className="absolute -left-10 top-20 bg-white p-4 rounded-2xl shadow-xl border border-slate-50 z-20 flex items-center gap-3"
            >
